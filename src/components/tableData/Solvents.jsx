...
function Solvents() {
  ...
  const [data,setModal,setId,flag,setFlag,setDeleteModal] = useOutletContext()
  ...
  return (
    ...
    <table class="w-full text-sm text-left text-white bg-[#2d3133] mt-2"ref={tableRef}>
        <tbody>
          ...
          return (
            <tr class="bg-white border-b dark:bg-[#2d3133] dark:border-gray-700"key={_id}>
            ...
            {chemicalName ? chemicalName : 'N/A'}
              ...
              <td class="px-6 py-3 text-xs font-display"> {size <= 0 ? 
              ...
              <td class="px-6 py-3 text-xs font-display">{new Date(expiry).toLocaleString().split(',')[0]}</td>
              <td class="px-6 py-3 text-xs font-display">
                <span class="font-medium text-xs hover:underline">
                  <div className="action-container flex justify-around items-center">
                    <span class="p-2 cursor-pointer hover:bg-gray-600" onClick={() => {
                      setModal(true)
                      setId(_id)
                    }}>
                      <BsFillPencilFill />{" "}
                    </span>
                    <span class="p-2 bg-red-400 cursor-pointer" onClick={() => {
                      setId(_id)
                      setDeleteModal(true)
                    }}>
                      <AiTwotoneDelete />
